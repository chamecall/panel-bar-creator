...
class Circle:
    ...
    def generate_gradient_circle(diameter, percentage, front_color, back_color=Color.WHITE):
        ...
        b, g, r = front_color
        b_step, g_step, r_step = (255 - b) / MAX_PERCENT_VALUE, (255 - g) / MAX_PERCENT_VALUE, (255 - r) / MAX_PERCENT_VALUE
        ...
        for i in range(1, percentage+1):
            ...
            cur_color = (255 - int(i * b_step), 255 - int(i * g_step), 255 - int(i * r_step))
            cv2.ellipse(circle, (diameter // 2, diameter // 2), (radius, radius), -90, prev_degree, degree, cur_color, Circle.BORDER_THICKNESS)


        degrees = int(percentage * ONE_PERCENT_IN_DEGREES)
        if degrees != 360:
            cv2.ellipse(circle, (diameter // 2, diameter // 2), (radius, radius), -90, degrees, 360, back_color, Circle.BORDER_THICKNESS)
        ...
        cv2.putText(circle, str(percentage), text_point, Circle.FONT, Circle.TEXT_SCALE, Color.WHITE, Circle.TEXT_THICKNESS)

...
class PanelBar:
	...
	def __init__(self, photo, info):
		...
		self.background = self.generate_background((self.top_panel.shape[0] + self.BTW_PANELS_VERTICAL_MARGIN + self.bottom_panel.shape[0], self.top_panel.shape[1], 4))
		# uself.background = overlay_transparent(self.background, self.top_panel, (0, 0))
		...
		self.blend_images(self.background, self.bottom_panel, (0, self.top_panel.shape[0] + self.BTW_PANELS_VERTICAL_MARGIN))
